...
class MinkLocParams:
    ...
    def __init__(self, params_path, model_params_path=None):
        ...
        self.eval_database_files = [params.get("eval_database_file")]
        self.eval_query_files = [params.get("eval_query_file")]
        print("------------>", self.eval_database_files)
        self.use_cloud = params.getboolean("use_cloud", False)
        self.use_rgb = True
