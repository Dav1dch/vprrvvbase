...
from datasets.augmentation import MinimizeTransform


class SevenScenesDatasets(Dataset):
    """
    Dataset wrapper for Oxford laser scans dataset from PointNetVLAD project.
    """
    ...
    def __init__(
        ...
        self.image_transform = MinimizeTransform()
        self.image_ext = ".png"
    ...
    def __getitem__(self, ndx):
        ...
        #     img = image4lidar(
        #         filename, self.image_path, self.image_ext, self.lidar2image_ndx, k=None
        #     )
